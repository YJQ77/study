...
/**
 * Author: YinJiaqi
 * Date: 10/30/2020 2:38 PM
 * Content:
 */
public class ZookeeperNative {
    public static final String connect = "172.16.130.82:2181";
    private static ZooKeeper zookeeper = null;
    private static CountDownLatch cdl = new CountDownLatch(1);
    private static String nodePath = "/yinjiaqi";
    private static String nodeChildPath = "/xuqiong/shenyiding";
